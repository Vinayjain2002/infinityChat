...
export const SignUpUser = () => {
  ...
  return (
    <div className="min-h-screen min-w-screen bg-primaryLightColor flex items-center justify-center px-3 py-5">
      <ToastContainer />
      <div className="h-full w-full max-w-[500px]">
        ...
        <div className="shadow-md mt-5 bg-white px-4 py-5 border rounded-md">
          <div className="text-xl font-bold text-gray-600">Create Account</div>
